<template>
  ...
  <div class="p-grid p-fluid dashboard">
    ...
    <div class="p-col-12 p-md-6 p-xl-3">
      ...
      <div class="highlight-box">
        ...
        <div class="highlight-details">
          ...
          <span>Total Queries</span>          <span class="count">523</span>   
             
        </div>
             
      </div>
    ...
    <div class="p-col-12 p-md-6 p-xl-3">
      ...
      <div class="highlight-box">
        ...
        <div class="highlight-details">
          ...
          <span>Total Issues</span>          <span class="count">81</span>     
           
        </div>
             
      </div>
    ...
    <div class="p-col-12 p-md-6 p-xl-3">
      ...
      <div class="highlight-box">
        ...
        <div class="highlight-details">
          ...
          <span>Open Issues</span>          <span class="count">21</span>       
        </div>
             
      </div>
         
    ...
    <div class="p-col-12 p-md-6 p-xl-3">
      ...
      <div class="highlight-box">
        ...
        <div class="highlight-details">
          ...
          <span>Closed Issues</span>          <span class="count">60</span>     
           
        </div>
             
      </div>
    ...
       
    <!-- <div class="p-col-12 p-lg-4 contacts">      <Panel header="Contacts">        <ul>          <li>            <button class="p-link">              <span class="name">Claire Williams</span>              <span class="email">clare@primevue.com</span>            </button>          </li>          <li>            <button class="p-link">              <span class="name">Jason Dourne</span>              <span class="email">jason@primevue.com</span>            </button>          </li>          <li>            <button class="p-link">              <span class="name">Jane Davidson</span>              <span class="email">jane@primevue.com</span>            </button>          </li>          <li>            <button class="p-link">              <span class="name">Tony Corleone</span>              <span class="email">tony@primevue.com</span>            </button>          </li>        </ul>      </Panel>    </div> -->
       
    <div class="p-col-12 p-lg-4">
           
